...
const customerDetailPage = `import DashboardLayout from "@/components/DashboardLayout";
...
fs.writeFileSync('client/src/pages/CustomerDetail.tsx', customerDetailPage);
console.log('✓ CustomerDetail.tsx created');
